...
public class EnemyAnimationScript : MonoBehaviour {
	...
	void Awake()
	{
		...
		if (anim_idle != null)
		{
			...
			animations[0].transform.localScale = new Vector3(1, 1, 1);
		...
		if (anim_walk_1 != null)
		{
			...
			animations[1].transform.localScale = new Vector3(1, 1, 1);
		...
		if (anim_walk_2 != null)
		{
			...
			animations[2].transform.localScale = new Vector3(1, 1, 1);
		...
		if (anim_leap != null)
		{
			...
			animations[3].transform.localScale = new Vector3(1, 1, 1);
		...
		if (anim_death != null)
		{
			...
			animations[4].transform.localScale = new Vector3(1, 1, 1);
